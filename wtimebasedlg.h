#ifndef WTIMEBASEDLG_H
#define WTIMEBASEDLG_H
...
/*
 调度计划界面
*/
class WTimeBaseDlg : public QDialog
{
    Q_OBJECT
public:
    explicit WTimeBaseDlg(QWidget *parent = 0);
    ~WTimeBaseDlg();
    void initDlg();
